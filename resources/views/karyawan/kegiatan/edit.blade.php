...
<div class="card shadow mb-4">
	...
	<div class="card-body">
		<form class="row g-3" action="{{ route('kegiatankaryawan.update', ['kegiatankaryawan' => $data->id]) }}" method="POST">
			@csrf
            @method('PUT')
			...
			<div class="col-md-5">
			  ...
			  <textarea class="form-control" name="kegiatan" id="exampleFormControlTextarea1" rows="10">{{ $data->kegiatan }}</textarea>
			</div>
